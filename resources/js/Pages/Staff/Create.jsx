...
export default function Create({ auth }) {
    ...
    return (
        <AdminLayout title="Add Staff" auth={auth}>
            <div className="flex flex-col gap-10 max-w-3xl mx-auto w-full">
                <div className="flex justify-between items-end border-b border-gray-200 pb-6">
                    <div>
                        ...
                        <h1 className="text-4xl md:text-5xl font-black uppercase tracking-tighter text-gray-900">Add Staff</h1>
                    </div>
                </div>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div>
                                    <label className="block text-[10px] font-mono text-gray-400 uppercase tracking-widest font-bold mb-2">NRP</label>
                                    <input
                                        type="text"
                                        value={data.nrp}
                                    ...
                                    />
                                    {errors.nrp && <div className="text-red-500 text-xs mt-1">{errors.nrp}</div>}
                                </div>
                                ...
                                <div className="md:col-span-2">
                                    <label className="block text-[10px] font-mono text-gray-400 uppercase tracking-widest font-bold mb-2">Password</label>
                                    <input
                                        type="password"
                                        value={data.password}
